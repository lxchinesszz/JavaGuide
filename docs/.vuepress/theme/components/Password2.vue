<template>
  <div class="password divide-y divide-fuchsia-300" :class="{ expand: page || isMainPage }">
    <div class="passImgDiv shadow-xl bg-white rounded-lg h-18">
      <img class="passImg" src="https://img.springlearn.cn/learn_c3d5074d94563b8297f81633f171d230.jpeg" alt="">
    </div>
    <div class="hint font-mono text-purple-700 text-opacity-50" :class="{ hasTried }">
